				...
				{isOpen && (
					<div className="z-30  divide-y absolute bg-[#1f1f1f] shadow w-44" style={{ top: menuPosition.top, left: menuPosition.left }}>
						<ul className="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
							<li>
								<a href="#" className="block px-4 py-2 dark:hover:bg-[#252525] dark:hover:text-white">
									Reward
								</a>
							</li>
							<li>
								<a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-[#252525] dark:hover:text-white">
									Promote
								</a>
							</li>
							<li>
								<p className="block px-4 py-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-[#252525] dark:hover:text-white">Create Playlist</p>
							</li>
						</ul>
						<div className="py-1 text-sm">
							<p onClick={() => signOut()} className="cursor-pointer block px-4 py-2 text-white hover:bg-gray-100 dark:hover:bg-[#252525] dark:hover:text-white">
								Sign Out
							</p>
						</div>
					</div>
				...
				<div className="flex flex-col justify-start items-start w-full left-0 top-0 overflow-hidden gap-3 px-3 pt-4 pb-8 bg-[#212124] h-screen">
					...
					<div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative">
						...
						{playlists.map((playlist, index) => (
							<div key={index + '-playlist'} onClick={() => router.push('/playlists/' + playlist.id)} className="flex justify-start items-center flex-grow-0 flex-shrink-0 w-[216px] relative gap-2.5 p-3 rounded-lg cursor-pointer">
