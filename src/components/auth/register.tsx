...
export default function RegisterComponent() {
	...
	const register = (
		<div className="w-full max-w-md space-y-8">
			...
			<Card className="backdrop-blur-xl shadow-lg md:border border-0">
					...
					<form
						...
						<div>
							...
							<div className="relative">
								...
								<Input type="text" placeholder="Enter 6-digit code" {...codeForm.register('code')} className="w-full h-10 bg-zinc-800 border-border focus:border-primary/50 focus:ring-primary/20 rounded-md text-center tracking-[0.5em] font-mono" maxLength={6} />
							</div>
