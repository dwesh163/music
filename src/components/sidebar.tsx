...
import { History, Library, ListMusic, Mic2, Podcast, Radio, Star, ListPlus, Play, Plus } from 'lucide-react';
					...
					<>
						{status === 'unauthenticated' ? (
							...
							<div className="w-full flex justify-center">
								<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="dark:stroke-slate-200 stroke-slate-950">
									<style>
										{`
                  .spinner_V8m1 {
