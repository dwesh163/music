				...
				<div className="w-full h-full relative flex overflow-hidden bg-[#171719]">
					...
					{error == '' ? (
						<div
							...
							<div className={'container w-full relative' + (artist?.artist?.images[0]?.url ? ' h-32 sm:h-64' : '')}>
								{artist?.artist?.images[0]?.url ? <img src={artist.artist.images[0].url} className="absolute inset-0 w-full h-full object-cover" /> : <></>}
